...
class XyzAdapter extends AbstractAdapter
{
    public function getProducts(): array
    {
        $produtosRaw = $this->loadJson(base_path('erpXyz/produtos-erp-xyz.json'));
        $variacoesRaw = $this->loadJson(base_path('erpXyz/variacoes-erp-xyz.json'));
